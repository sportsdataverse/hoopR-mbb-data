...
def test_write_dataset_skips_tree_csv_for_write_tree_csv_false(tmp_path):
    # MBB/MBB delta: pbp/team_box/player_box never commit a local csv (R's
...
def test_manifest_is_an_append_log_with_source_endpoint(tmp_path):
    ...
    assert (
        ...
        == [
            "https://raw.githubusercontent.com/sportsdataverse/hoopR-mbb-raw/main/mbb/standings/json/2025.json"
        ]
        * 2
    )
