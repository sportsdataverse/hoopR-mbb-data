...
Ported verbatim from the hoopR-nba-data ``python/tests/nba_data_build``
template (league-neutral -- no NBA/MBB-specific logic), itself ported from
the wehoop-wnba-data ``python/tests/wnba_data_build`` template.
"""
