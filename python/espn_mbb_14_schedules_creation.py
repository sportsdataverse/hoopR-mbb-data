...
**No numbered R stage produces `schedules` on its own.** R emits it inside ``R/espn_mbb_01_pbp_creation.R``, ``R/espn_mbb_02_team_box_creation.R``.
...
Equivalent to::
    ...
    python -m mbb_data_build --dataset schedules -s <start> -e <end>
"""
