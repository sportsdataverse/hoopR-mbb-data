...
Mirrors ``R/espn_mbb_06_team_season_stats_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_mbb_06_team_season_stats_creation.R``.

Equivalent to::

    python -m mbb_data_build --dataset team_season_stats -s <start> -e <end>
"""
