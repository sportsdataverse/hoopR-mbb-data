...
Mirrors ``R/espn_mbb_10_officials_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_mbb_10_officials_creation.R``.

Equivalent to::

    python -m mbb_data_build --dataset officials -s <start> -e <end>
"""
