...
Mirrors ``R/mbb_13_player_crosswalk_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/mbb_13_player_crosswalk_creation.R``.

Equivalent to::

    python -m mbb_data_build --dataset player_crosswalk -s <start> -e <end>
"""
