...
Mirrors ``R/espn_mbb_09_game_rosters_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_mbb_09_game_rosters_creation.R``.

Equivalent to::

    python -m mbb_data_build --dataset game_rosters -s <start> -e <end>
"""
