...
PKG_FUNCTION: dict[str, str] = {
    "mbb_player_value": "sportsdataverse.mbb.load_mbb_player_value()",
    "mbb_ratings": "sportsdataverse.mbb.load_mbb_ratings()",
}
_PRODUCER = "python/mbb_model_publish/artifacts.py"
