...
Mirrors ``R/espn_mbb_04_rosters_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_mbb_04_rosters_creation.R``.

Equivalent to::

    python -m mbb_data_build --dataset rosters -s <start> -e <end>
"""
