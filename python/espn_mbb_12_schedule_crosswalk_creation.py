...
Mirrors ``R/mbb_12_schedule_crosswalk_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/mbb_12_schedule_crosswalk_creation.R``.

Equivalent to::

    python -m mbb_data_build --dataset schedule_crosswalk -s <start> -e <end>
"""
